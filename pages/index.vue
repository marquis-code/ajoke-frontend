        ...
        <header class="absolute inset-x-0 top-0 z-50">
            <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <div class="flex lg:hidden">
                    <button type="button" @click="isMobile = true"
                ...
                <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                    <NuxtLink to="/login" class="text-sm font-semibold leading-6 text-gray-900">Log in <span
            ...
            <div v-if="isMobile" class="lg:hidden" role="dialog" aria-modal="true">
                ...
                <div
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <button @click="isMobile = false" type="button" class="-m-2.5 rounded-md p-2.5 text-gray-700">
                        ...
                        <div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                            <div class="relative w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                                <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">We’re changing
                                    the way people split bills with friends.</h1>
                                <p class="mt-6 text-lg leading-8 text-gray-600 sm:max-w-md lg:max-w-none">Cupidatat
                                    ...
                                    aliqua anim nulla sunt mollit id pariatur in voluptate cillum.</p>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="relative">
                                        <img src="https://abahernest.github.io/ajoke_mvp/images/friendgroup.png" alt=""
                                ...
                                <div class="mr-auto w-44 flex-none space-y-8 sm:mr-0 sm:pt-52 lg:pt-36">
                                    ...
                                    <div class="relative">
                                        <img src="@/assets/img/friends2.jpg" alt=""
                                            class="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg">
                                        <div
                                            class="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10">
                                        </div>
                                ...
                                <div class="w-44 flex-none space-y-8 pt-32 sm:pt-0">
                                    <div class="relative">
                                        <img src="@/assets/img/friends4.jpg" alt=""
                                            class="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg">
                                        <div
                                            class="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10">
                                        </div>
                                    ...
                                    <div class="relative">
                                        <img src="@/assets/img/friends3.jpg" alt=""
                                            class="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg">
                                        <div
                                            class="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10">
                                        </div>
