<template>
    <main>
        <header class="absolute inset-x-0 top-0 z-50">
            <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <!-- <div class="hidden lg:flex lg:gap-x-12">
                    ...
                    <a href="#projects" class="text-sm font-semibosxld leading-6 text-white">Projects</a>
                </div> -->
                <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                    <a href="tel:+2348147626503" class="text-sm font-semibold leading-6 text-white">Contact Me <span
                            aria-hidden="true">&rarr;</span></a>
                </div>
            </nav>
            <div class="lg:hidden" v-if="isMobile" role="dialog" aria-modal="true">
        ...
        <section class="h-screen lg:h-full max-h-screen w-screen  bg-black">
            <div class="grid lg:grid-cols-2 gap-6 pt-10 lg:pt-0">
                ...
                <div class="flex flex-col items-start px-6 lg:pl-14 justify-center">
                    <div>
                        <h1 data-aos="flip-left" class="text-4xl lg:text-7xl py-0 my-0 text-green-500 font-semibold">
                            Frontend Software</h1>
                        <h1 data-aos="flip-left" class="text-4xl lg:text-7xl py-0 my-0 text-green-500 font-semibold">
                            Engineer</h1>
                    </div>
                    <div class="pt-10">
                        <p data-aos="flip-left" class="text-gray-400 lg:text-lg py-0 my-0"> <span
                                class="font-semibold text-white">Hey,👋
                            </span> thanks
                            for
                            reaching
                            here,</p>
                        <p data-aos="flip-left" class="text-gray-400 pt-2 lg:text-lg py-0 my-0">Take a look around.
                            <NuxtLink to="/profile" target="_blank" class="text-sm font-semibold leading-6 text-white">
                                Click
                                to
                                explore<span aria-hidden="true">→</span></NuxtLink>
                        </p>
                    </div>
                    <div class="flex space-x-6 pt-6">
                        <!-- <a data-aos="flip-left" href="#" class="text-gray-500 hover:text-gray-400">
                        ...
                        <a data-aos="flip-left" href="https://github.com/marquis-code"
                        ...
                        <a data-aos="flip-left" href="https://www.linkedin.com/in/marquis-abah-584a12199"
                            class="text-gray-500 hover:text-gray-400">
                ...
                <div data-aos="flip-left" class="hidden lg:flex justify-end items-end pr-14">
                    <div data-aos="flip-left" class="flex items-center justify-center min-h-screen">
                        <div data-aos="flip-left" class="relative">
                            <div data-aos="flip-left" class="absolute inset-0 flex items-center justify-center">
                                <div class="w-[600px] h-[600px] rounded-full border border-green-500"></div>
                            </div>
                            <img data-aos="flip-left" src="@/assets/img/profile4.jpeg" alt="Circular Image"
                                class="rounded-full w-[600px] h-[600px] object-cover p-6" />
                        </div>
                    </div>
                </div>
            </div>
